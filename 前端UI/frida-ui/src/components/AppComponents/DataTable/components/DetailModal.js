...
import { convertToHex, convertToAscii, magicDecode } from '../utils';
    ...
    >
      {selectedRecord && (
        <Tabs defaultActiveKey="1" tabBarStyle={{ margin: 0 }}>
          <TabPane tab="基本信息" key="1" forceRender>
            <div className="tab-content">
              <Descriptions bordered column={1} size="small">
                ...
                <Descriptions.Item label="时间戳">{selectedRecord.timestamp}</Descriptions.Item>
                <Descriptions.Item label="方法">
                  <div className="data-content">
                    <Tag color="blue">{selectedRecord.method}</Tag>
                  </div>
                </Descriptions.Item>
                <Descriptions.Item label="参数">
                  <div className="data-content">
                    {renderArgsList(selectedRecord.args)}
                  </div>
                </Descriptions.Item>
                <Descriptions.Item label="返回值">
                  <div className="data-content">
                    {renderReturnValue(selectedRecord.returns)}
                  </div>
                </Descriptions.Item>
              </Descriptions>
            </div>
              ...
              <Descriptions bordered column={1} size="small">
                ...
                <Descriptions.Item label="参数 (Hex)">
                  <div className="data-content hex-content">
                    {renderArgsList(selectedRecord.args, convertToHex)}
                  </div>
                </Descriptions.Item>
                <Descriptions.Item label="返回值 (Hex)">
                  <div className="data-content hex-content">
                    {renderReturnValue(selectedRecord.returns, convertToHex)}
                  </div>
                </Descriptions.Item>
              </Descriptions>
            </div>
          ...
          <TabPane tab="ASCII" key="3" forceRender>
            <div className="tab-content">
              <Descriptions bordered column={1} size="small">
                <Descriptions.Item label="方法 (原始)">
                  <div className="data-content">
                ...
                <Descriptions.Item label="参数 (ASCII)">
                  <div className="data-content">
                    {renderArgsList(selectedRecord.args, convertToAscii)}
                  </div>
                </Descriptions.Item>
                <Descriptions.Item label="返回值 (ASCII)">
                  <div className="data-content">
                    {renderReturnValue(selectedRecord.returns, convertToAscii)}
                  </div>
                </Descriptions.Item>
              </Descriptions>
            </div>
          ...
          <TabPane tab="Magic解码" key="4" forceRender>
            <div className="tab-content">
              <Descriptions bordered column={1} size="small">
                <Descriptions.Item label="方法 (原始)">
                  <div className="data-content">
                ...
                <Descriptions.Item label="参数 (Magic)">
                  <div className="data-content">
                    {renderArgsList(selectedRecord.args, magicDecode)}
                  </div>
                </Descriptions.Item>
                <Descriptions.Item label="返回值 (Magic)">
                  <div className="data-content">
                    {renderReturnValue(selectedRecord.returns, magicDecode)}
                  </div>
                </Descriptions.Item>
              </Descriptions>
            </div>
          ...
          <TabPane tab="原始数据" key="5" forceRender>
            <div className="tab-content">
              <pre style={{ 
